...
const SidebarContent = ({ onItemClick }: { onItemClick?: () => void }) => {
    ...
    const activeBg = useColorModeValue(theme.colors.brand['500'], theme.colors.brand['500']);
    ...
    const menuGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Reports', href: '/reports', icon: FiClipboard, roles: ['admin'] },
                                ...
                                <Stack spacing={1} pl={1} mt={1}>
                                    {group.items.map((item) => (
                                        <Button
                                            ...
                                            color={pathname === item.href ? iconColor : iconColor}
