...
<body>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>ENHANCED REQUISITION SUMMARY REPORT - GENERATED BY STOCKWISE PROCUREMENT SYSTEM</p>
        <p>Triptych Solutions Solutions | ${new Date().getFullYear()} | Document ID: ERS-${currentDate.replace(/\//g, '')}-${Math.random().toString(36).substr(2, 8).toUpperCase()}</p>
